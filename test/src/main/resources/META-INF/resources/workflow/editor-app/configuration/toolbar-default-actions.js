...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
            window.parent.document.getElementById('modelEditorDiv').style.display = 'none'
            window.parent.document.getElementById('modelList').style.display = 'block'
            window.parent.document.getElementById('modelEditor').setAttribute('src', '')
        },
