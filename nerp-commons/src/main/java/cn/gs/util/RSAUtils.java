...
public class RSAUtils {
     ...
     * @throws Exception
     */
    public static String signToHexString(byte[] data, String privateKey) throws Exception {
         return ByteUtil.toHexString(sign(data, privateKey));
    }
     ...
     * @throws Exception
     */
    public static String signToBase64String(byte[] data, String privateKey) throws Exception {
...
//            String source = "CRC（Cyclic Redundancy Check，循环冗余校验）算法出现时间较长，应用也十分广泛，尤其是通讯领域";
...
//            String sign = RSAUtils.signToHexString(encodedData, privateKey);
//            System.err.println("签名:\r" + sign);
//            boolean status = RSAUtils.verify(encodedData, publicKey, ByteUtil.hexStringToByteArray(sign) );
